...
- 2nd argument: A consumer with several methods:
    - `.consumeChance(number)`{: .language-kube-18 }: Accepts a number, {% in_unit %}, and sets the chance a fluid block will be consumed, defaults to 0
    ...
    - `.effect(String, Consumer<EffectData>?)`{: .language-kube-18 }
        ...
        - *optional 2nd argument*: A consumer with several methods:
            ...
            - `.chance(number)`{: .language-kube-18 }: Accepts a number, {% in_unit %}, and sets the chance the effect will be applied per 25mB drank, defaults to 1
...
- 2nd argument: A consumer with several methods
    ...
    - `.extraSeedChance(number)`{: .language-kube-18 }: Accepts a number, {% in_unit %}, sets the chance of getting a second seed back, defaults to 0.5
...
Returns the nutrient value {% in_unit %}. accepts `grain`, `fruit`, `vegetables`, `protein`, and `dairy`
