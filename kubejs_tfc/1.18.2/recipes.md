...
- 2nd argument: A list of contents, each containing three variables:
    ...
    - A number, {% in_unit %}, representing the minimum portion needed in the mixture
    - A number, {% in_unit %}, representing the maximum portion needed in the mixture
...
- 3rd argument: A [fluid stack ingredient]({% link kubejs_tfc/1.18.2/wrappers.md %}#fluid-stack-ingredient)
- *optional 4th argument*: A number, {% in_unit %}, representing the chance that the mold will break upon completion of this recipe
