...
- 3rd argument: A number, {% in_range 1,16 %}, the radius around the target location to place spikes in
...
- 4th argument: A number, {% in_range 1,16 %}, the approximate radius of the spring
