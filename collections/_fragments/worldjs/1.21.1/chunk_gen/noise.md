...
- `.noiseSettings(settings: Holder$Reference<NoiseGeneratroSettings>)`{: .language-kube-21 #{{ page.anchor }}-noise-setting }: The [noise settings](#noise-generator-settings) of the world
    - [[ required ]]
