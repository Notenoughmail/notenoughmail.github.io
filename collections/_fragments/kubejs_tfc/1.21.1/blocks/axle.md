...
- `.axleTexture(texture: ResourceLocation)`{: .language-kube-21 #axle-texture }: Set the texture of the axle
- `.windmill(windmill: Consumer<WindmillBlockBuilder>)`{: .language-kube-21 #axle-windmill }: Set the properties of the windmill associated with the axle. Accepts a consumer with the methods
...
- `.waterWheel(waterWheel: Consumer<WaterWheelBlockBuilder>)`{: .language-kube-21 #axle-water-wheel }: Create and set the properties of the water wheel associated with the axle. Accepts a consumer with the methods
    ...
    - All those of the default block builder
- `.gearBox(gearBox: Consumer<GearBoxBlockBuilder>)`{: .language-kube-21 #axle-gear-box }: Create and set the properties of the gear box associated with the axle. Accepts a consumer with the methods
    ...
    - All those of the default block builder
- `.clutch(clutch: Consumer<ClutchBlockBuilder>)`{: .language-kube-21 #axle-clutch }: Create and set the properties of the clutch associated with the axle. Accepts a consumer with the methods
    ...
    - All those of the default block builder
- `.bladedAxle(bladed: Consumer<BladedAxleBlockBuilder>)`{: .language-kube-21 #axle-bladed-axle }: Create and set the properties of the bladed axle associated with the axle. Accepts a consumer with the methods
    ...
    - All those of the default block builder
- `.extendedProperties(extendedProperties: Consumer<ExtendedProperties>)`{: .language-kube-21 #axle-extended-properties }: Set the [extended properties](#extended-properties) of the axle
