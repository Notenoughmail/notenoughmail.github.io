...
anchor: random-tree
type: random_tree
wiki_link: https://terrafirmacraft.github.io/Documentation/1.21.x/worldgen/features/trees/#random-tree
sort_pos: f_t
cat:
    - kubejs_tfc
    - 1.21.1
...
- `.trees(trees: List<ResourceLocation>)`{: .language-kube-21 #{{ page.anchor }}-trees }: The tree structures to randomly choose from to place. Ids of structures located at `data/<namespace>/structures/<path>.nbt`
    - [[ required ]]
